...
copyright = '2018, Jupyter Contributors'
...
release = jupyterhub_traefik_proxy.__version__
version = release
...
html_theme_options = {
    'description': 
    """
    An implementation of the JupyterHub proxy api with traefik
    """
}
...
htmlhelp_basename = 'JupyterHubTraefikProxydoc'
